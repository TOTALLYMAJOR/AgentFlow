...
vi.mock("swr", () => ({ default: () => ({ data: [{ id: "initiative_1", title: "Coordinated release", objective: "Ship provider and consumer", status: "partial", digest: "abc123", updatedAt: "now", dependencies: [{ producerPlanId: "plan_a", consumerPlanId: "plan_b", dependencyType: "artifact", artifactName: "api", artifactVersion: "1.0.0" }], members: [{ repositoryId: "repo_a", planId: "plan_a", baseCommit: "aaa", buildId: "build_a" }, { repositoryId: "repo_b", planId: "plan_b", baseCommit: "bbb", buildId: null }] }], isLoading: false, error: undefined, mutate: vi.fn() }) }));
vi.mock("@primer/react", () => ({ Button: ({ children }: { children: React.ReactNode }) => <button>{children}</button>, Flash: ({ children }: { children: React.ReactNode }) => <div>{children}</div> }));
